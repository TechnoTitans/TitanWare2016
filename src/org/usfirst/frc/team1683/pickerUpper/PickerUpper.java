...
//			angle = MIN_ANGLE;
//	
//		double inches = angle * (MAX_INCHES-MIN_INCHES)/(MAX_ANGLE-MIN_ANGLE);
//		
//		return inches;
//		
//		
//	}
	...
	public void anglePickerUpper() {
		double inches = (MAX_INCHES-MIN_INCHES) * (DriverStation.auxStick.getRawAxis(DriverStation.ZAxis) + 1)/2 + MIN_INCHES;
